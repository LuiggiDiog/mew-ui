  ...
  return (
    <article id={id} className="scroll-mt-24 space-y-5 rounded-xl border border-border bg-surface p-5">
      ...
      <section className="space-y-2">
        <p className="text-xs font-medium uppercase tracking-wide text-text-secondary">Preview</p>
        <div className="rounded-lg border border-border bg-background p-3">
        {item.preview ? (
          <ComponentPreview name={item.name} />
        ) : (
          <p className="text-xs text-text-secondary">Preview not isolated. Use the composition snippet below.</p>
        )}
        </div>
      </section>

      <section className="space-y-3">
        <p className="text-xs font-medium uppercase tracking-wide text-text-secondary">Usage</p>
        <VariationBlock title="Basic usage" code={item.snippet} />
      </section>

      <section className="space-y-3">
        <p className="text-xs font-medium uppercase tracking-wide text-text-secondary">Variations</p>
      ...
      <section className="space-y-2">
        <p className="text-xs font-medium uppercase tracking-wide text-text-secondary">Composition exports</p>
